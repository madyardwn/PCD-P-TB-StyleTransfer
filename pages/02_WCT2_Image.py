...
def main():
    ...
    if content_file is not None and style_file is not None:
        ...
        uploaded_content = os.path.join("images", "content.png")

        # Mengatur path untuk menyimpan citra style yang baru diupload
        uploaded_style = os.path.join("images", "style.png")
        ...
        if st.button("Proses citra"):
            ...
            func.perform_style_transfer(uploaded_content, uploaded_style, "images")
